...
<ul class="tabs black center-align">
    <li class="tab col s4"><a class="white-text waves-effect waves-light" href="#style_tab">Style</a></li>
    <li class="tab col s4"><a class="active white-text waves-effect waves-light" href="#hair_and_body_tab">Hair and body care</a></li>
    <li class="tab col s4"><a class="white-text waves-effect waves-light" href="#shave_tab">Shave</a></li>
