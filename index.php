    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col s12 m3 l5 hide-on-small-and-down">
                <h3 class="white-text center-align" style="font-family: Moandhand">Horario</h3>
                <p class="white-text center-align" style="font-family: Moandhand; font-size: x-large">Lunes a viernes: 9:00h-14:00h y 16:00-20:00h</p>
                <p class="white-text center-align" style="font-family: Moandhand; font-size: x-large">Sabados: 9:00h-14:00h y 16:00-20:00h</p>
            ...
            <div class="col s12 m3 l5 hide-on-med-and-up">
                <h3 class="white-text center-align" style="font-family: Moandhand;">Horario</h3>
                <p class="white-text center-align" style="font-family: Moandhand; font-size: large">Lunes a viernes: 9:00h-14:00h y 16:00-20:00h</p>
                <p class="white-text center-align" style="font-family: Moandhand; font-size: large">Sabados: 9:00h-14:00h y 16:00-20:00h</p>

                <a href="tel:914632680" class="btn-large hide-on-med-and-up waves-effect waves-light green white-text col s8 offset-s2"
                   style="margin-bottom: 5%; font-family: Moandhand; font-size: medium; padding-top: 5px;">
                    <i class="material-icons right" style="margin-top: -5px">telephone</i>Llámanos</a>
